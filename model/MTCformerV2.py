...
class ConvolutionalAttentionBlock(nn.Module):
    ...
    2. Temporal convolution over time:
       - Uses a regular conv (`groups=1`) to mix local temporal features.
    ...
    3. GELU + Dropout + Residual Connection
        ...
        – A residual connection (skip connection) helps stabilize training and enables deeper architectures.
